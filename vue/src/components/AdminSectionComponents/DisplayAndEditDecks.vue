    ...
    <div class="deckarea">
        ...
        <div :class="(deck.deckId == currentDeckId) ? 'selecteddeck': 'deck'" v-for="deck in sortedList"
            ...
            <div class="decktitlebox">
                ...
                <div class="editdeck" @click="isShowEdit = !isShowEdit; setEditDeck(deck)">
            ...
            <div class="form-control">
              <textarea class="editinput" type="text" v-model="editDeckName" name="editDeckName" placeholder="Enter name..." />
            </div>
            <div class="editdescription"> 
            </div>
            <div class="form-control">
                <textarea class="editinput " type="text" v-model="editDeckDescription" name="editDeckDescription" placeholder="Enter description...."/>
            </div>
            </div>
            </div>
            </form>
        ...
        <div class="deck">
            ...
            <div class="editname">   
            <div class="form-control">
              <textarea class="editinput" type="text" v-model="deckName" name="deckName" placeholder="Enter name..." />
            </div>
            <div class="editdescription"> 
            </div>
            <div class="form-control">
                <textarea class="editinput " type="text" v-model="deckDescription" name="deckDescription" placeholder="Enter description...."/>
            </div>
            </div>
            </div>
            </form>
